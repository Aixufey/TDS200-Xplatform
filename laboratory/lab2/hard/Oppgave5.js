...
var _this = this;
var usePokeAPI = function (resp) { return __awaiter(_this, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!resp.isLoading) return [3 /*break*/, 2];
...
var getPikachu = function () { return __awaiter(_this, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://pokeapi.co/api/v2/pokemon/pikachu")];
            case 1:
                data = _a.sent();
                usePokeAPI(data);
                return [2 /*return*/];
